...
describe User do
  ...
  describe "password encryption" do
    ...
    describe "authenticate method" do
      ...
      it "devrait retourner nul en cas d'inequation entre email et mot de passe" do
      ...
      it "devrait retourner l'utilisateur si email et mot de passe correspondent" do
